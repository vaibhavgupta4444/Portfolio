...
const Content = ({line1,line2,line3,line4,mode}) => {
  return (
    <motion.div initial={{y:50,opacity:0}} whileInView={{y:0,opacity:1}} transition={{ease:'easeInOut',duration:1,type:'spring'}} className={`text-sm ${mode === 'theme-light' ? 'text-[#555]' : 'text-[#AAAAAA]'}`}>
